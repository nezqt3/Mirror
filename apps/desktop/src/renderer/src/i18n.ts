...
void i18n.use(initReactI18next).init({
  resources: {
    en: { settings: settingsEn, character: characterEn, app: appEn },
    ru: { settings: settingsRu, character: characterRu, app: appRu },
    zh: { settings: settingsZh, character: characterZh, app: appZh },
  },
